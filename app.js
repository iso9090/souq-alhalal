...
// =====================================
// تجهيز صور الحيوان
// نسخة تجريبية بدون Firebase Storage
// =====================================
  ...
  try {
    ...
    try {
      ...
      if (
        ...
        alert(
          "❌ حجم الصور كبير جداً.\n\nجرّب اختيار صور أقل أو صور أصغر."
        );
      ...
      alert(
        "❌ تعذر تجهيز الصور. جرّب صورة أخرى."
      );
