...
const files=['trusted-backend-client.js','commercial-image.js','telemetry-page.js','commercial-model.js','commercial-public.js','commercial-admin.js','commercial.css','index.html','about.html','privacy.html','terms.html','refund-policy.html','delete-account.html','payment-demo.html','app.js','site-language.js','image-provider.js','marketplace-v2.js','listing-images-ui.js','home-page-admin.js','admin-dashboard.js','admin-assistants.js','admin-permissions.js','payment-demo.js','style.css','launch.css','marketplace-v2.css','admin-dashboard.css','hero-livestock.png','logo-souq-alhalal.png'];
